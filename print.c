...
void print_help(void)
{
	const char *message =
	        ...
	        "'iorb' addr       - read byte from port I/O\r\n"
	        "'iorw' addr       - read word from port I/O\r\n"
	        "'iord' addr       - read dword from port I/O\r\n"
	        "'iowb' addr value - write byte to port I/O\r\n"
	        "'ioww' addr value - write word to port I/O\r\n"
	        "'iowd' addr value - write dword to port I/O\r\n"
